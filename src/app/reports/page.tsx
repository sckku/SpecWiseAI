  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <button className="px-4 py-2 rounded-xl bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 text-sm font-semibold flex items-center space-x-1.5 shadow-xs">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-xs">
          ...
          <p className="text-sm text-emerald-600 mt-1">สอดคล้องตามเกณฑ์ราคากลาง 94%</p>
        </div>
        ...
        <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-xs">
          ...
          <p className="text-sm text-slate-400 mt-1">เทียบกับกระบวนการเดิม (ลดลง 72%)</p>
        </div>
        ...
        <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-xs">
          ...
          <p className="text-sm text-slate-400 mt-1">ตรวจพบข้อผิดพลาดก่อนส่งระดับคณะ</p>
        </div>
        ...
        <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-xs">
          ...
          <p className="text-sm text-slate-400 mt-1">ผ่านเกณฑ์ พ.ร.บ. จัดซื้อจัดจ้างฯ</p>
        </div>
      </div>
          ...
          <div className="space-y-2.5 text-sm">
            <div className="p-3 rounded-2xl bg-indigo-50/50 border border-indigo-100 flex justify-between items-center">
              <div>
                ...
                <div className="text-sm text-slate-500">เดิมใช้เวลา 4 ชม./รายการ → AI ใช้เวลา 3 วินาที</div>
              </div>
            ...
            <div className="p-3 rounded-2xl bg-indigo-50/50 border border-indigo-100 flex justify-between items-center">
              <div>
                ...
                <div className="text-sm text-slate-500">เดิมใช้เวลา 6 ชม./รายการ → AI ใช้เวลา 5 วินาที</div>
              </div>
            ...
            <div className="p-3 rounded-2xl bg-indigo-50/50 border border-indigo-100 flex justify-between items-center">
              <div>
                ...
                <div className="text-sm text-slate-500">เดิมตรวจซ้ำ 2-3 รอบ → AI ตรวจแบบ Real-time</div>
              </div>
