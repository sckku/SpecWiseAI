  ...
  const mockPersonas = [
    {
      ...
      roleTitle: "ผู้ใช้งาน 1 (สาขาวิชาเคมี)",
      roleBadge: "ผู้ใช้งาน",
      dept: "สาขาวิชาเคมี คณะวิทยาศาสตร์",
      position: "อาจารย์ / นักวิจัย",
      badgeColor: "bg-emerald-50 text-emerald-700 border-emerald-200",
      avatarBg: "bg-emerald-100 text-emerald-700",
      borderHover: "hover:border-emerald-300 hover:bg-emerald-50/40",
      icon: UserCheck,
      capabilities: "สร้างคำขอ • AI 6 สเต็ป • ดูคำขอในสาขาวิชาเดียวกัน",
    },
    {
      key: "requester_cs2",
      name: "ผศ.ดร.วิภาดา สมบูรณ์",
      roleTitle: "ผู้ใช้งาน 2 (สาขาวิชาเคมี)",
      roleBadge: "ผู้ใช้งาน (สาขาเดียวกัน)",
      dept: "สาขาวิชาเคมี คณะวิทยาศาสตร์",
      position: "อาจารย์ / นักวิจัย",
      badgeColor: "bg-emerald-50 text-emerald-700 border-emerald-200",
      avatarBg: "bg-emerald-100 text-emerald-700",
      borderHover: "hover:border-emerald-300 hover:bg-emerald-50/40",
      icon: UserCheck,
      capabilities: "สาขาเดียวกับ ดร.สมชาย • มองเห็นคำขอร่วมกันในสาขาเคมี",
    },
    {
      key: "requester_chem",
      name: "รศ.ดร.อนันต์ สิทธิชัย",
      roleTitle: "ผู้ใช้งาน 3 (สาขาวิชาฟิสิกส์)",
      roleBadge: "ผู้ใช้งาน (ต่างสาขา)",
      dept: "สาขาวิชาฟิสิกส์ คณะวิทยาศาสตร์",
      position: "อาจารย์ / นักวิจัย",
      badgeColor: "bg-teal-50 text-teal-700 border-teal-200",
      avatarBg: "bg-teal-100 text-teal-700",
      borderHover: "hover:border-teal-300 hover:bg-teal-50/40",
      icon: UserCheck,
      capabilities: "ต่างสาขาวิชา • มองเห็นเฉพาะคำขอในสาขาฟิสิกส์",
    },
    {
      key: "plan_admin",
      name: "นายสมศักดิ์ แผนดี",
      roleTitle: "แอดมิน (งานแผนและยุทธศาสตร์)",
      roleBadge: "แอดมิน / ผู้อนุมัติ",
      dept: "งานแผนและยุทธศาสตร์ กองแผนงาน",
      ...
      icon: Building2,
      capabilities: "อนุมัติคำขอ (Approve) • ส่งกลับแก้ไข • ดูได้ทั้งหมด",
    },
    {
      key: "procurement",
      name: "นางสาวกรกนก เพชรแท้",
      roleTitle: "งานคลังและพัสดุ",
      roleBadge: "คลังและพัสดุ",
      dept: "งานบริหารพัสดุและทรัพย์สิน กองคลังและพัสดุ",
      position: "นักวิชาการพัสดุ ชำนาญการพิเศษ",
      badgeColor: "bg-blue-50 text-blue-700 border-blue-200",
      avatarBg: "bg-blue-100 text-blue-700",
      borderHover: "hover:border-blue-300 hover:bg-blue-50/40",
      icon: ShieldCheck,
      capabilities: "ดูข้อมูลได้ทั้งหมด • ตรวจราคากลาง 4 ฐาน • แนบความเห็นพัสดุ",
    },
  ];
