    ...
    <div className="space-y-6 animate-in fade-in duration-300 pb-10">
      ...
      <div className="bg-gradient-to-r from-emerald-800 via-teal-900 to-slate-900 text-white rounded-3xl p-6 shadow-md flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex items-center space-x-2">
          <span className="px-3 py-1.5 rounded-xl bg-white/10 backdrop-blur-md text-emerald-300 border border-white/10 text-xs font-mono">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
            ...
            <div className="mt-4 space-y-2">
              ...
              <div className="space-y-1.5 text-xs">
                <div className="p-2 rounded-xl bg-amber-50/60 border border-amber-200/60 text-amber-900 flex items-center justify-between">
                  ...
                  <span className="text-[10px] text-amber-700 shrink-0 ml-1">12 นาทีที่แล้ว</span>
                </div>
                <div className="p-2 rounded-xl bg-slate-50 border border-slate-100 text-slate-700 flex items-center justify-between">
                  ...
                  <span className="text-[10px] text-slate-400 shrink-0 ml-1">1 ชม.</span>
                </div>
                <div className="p-2 rounded-xl bg-rose-50/60 border border-rose-200/60 text-rose-900 flex items-center justify-between">
                  ...
                  <span className="text-[10px] text-rose-700 shrink-0 ml-1">2 ชม.</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white border border-slate-200/80 rounded-3xl p-5 shadow-xs flex flex-col justify-between space-y-4">
          <div>
            ...
            {/* Risk Tabs */}
            <div className="flex space-x-1.5 mt-3 p-1 rounded-xl bg-slate-100 text-xs">
              <button
            ...
            <div className="mt-3 space-y-2 text-xs">
              <div className="p-2.5 rounded-xl border border-rose-100 bg-rose-50/30 flex items-center justify-between">
                <div>
                  ...
                  <div className="text-slate-500 text-[11px]">850,000 บาท</div>
                </div>
              ...
              <div className="p-2.5 rounded-xl border border-amber-100 bg-amber-50/30 flex items-center justify-between">
                <div>
                  ...
                  <div className="text-slate-500 text-[11px]">520,000 บาท</div>
                </div>
              ...
              <div className="p-2.5 rounded-xl border border-slate-100 bg-slate-50 flex items-center justify-between">
                <div>
                  ...
                  <div className="text-slate-500 text-[11px]">1,250,000 บาท</div>
                </div>
          ...
          <button className="w-full py-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-semibold">
            ดูทั้งหมด
          </button>
        </div>
        ...
        <div className="bg-white border border-slate-200/80 rounded-3xl p-5 shadow-xs flex flex-col justify-between space-y-4">
          <div>
            ...
            <div className="mt-3 space-y-2 text-xs">
              <div className="p-2.5 rounded-xl border border-slate-200 bg-slate-50/50 flex items-center justify-between">
                <div>
                  ...
                  <div className="text-[10px] text-slate-400">บัญชีราคามาตรฐาน ฉบับ เม.ย. 2569</div>
                </div>
              ...
              <div className="p-2.5 rounded-xl border border-amber-200 bg-amber-50/40 flex items-center justify-between">
                <div>
                  ...
                  <div className="text-[10px] text-slate-400">มาตรฐานคุณลักษณะ ฉบับ 2569</div>
                </div>
              ...
              <div className="p-2.5 rounded-xl border border-slate-200 bg-slate-50/50 flex items-center justify-between">
                <div>
                  ...
                  <div className="text-[10px] text-slate-400">เกณฑ์ราคากลาง ฉบับ พ.ศ. 2569</div>
                </div>
                <span className="px-2 py-0.5 rounded bg-emerald-100 text-emerald-800 text-[10px] font-bold">
                  Active
                </span>
            ...
            <div className="mt-3 p-2 rounded-xl bg-amber-50 border border-amber-200 text-[11px] text-amber-900 flex items-center space-x-1.5">
          ...
          <div>
            ...
            <div className="mt-3 p-3 rounded-2xl bg-gradient-to-br from-slate-900 to-indigo-950 text-white space-y-2">
              ...
              <div className="grid grid-cols-4 gap-1 text-center text-xs">
                <div>
                  <div className="text-[9px] text-slate-400">ราคามาตรฐาน</div>
                  <div className="font-bold text-white">26,000</div>
                </div>
                <div>
                  <div className="text-[9px] text-slate-400">ราคากลาง</div>
                  <div className="font-bold text-white">28,900</div>
                </div>
                <div>
                  <div className="text-[9px] text-slate-400">ใบเสนอราคา</div>
                  <div className="font-bold text-emerald-400">28,500</div>
                </div>
                <div>
                  <div className="text-[9px] text-slate-400">ประวัติจัดซื้อ</div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2 mt-3 text-center">
              <div className="p-2 rounded-xl bg-indigo-50 border border-indigo-100">
                ...
                <div className="text-[9px] text-slate-500">TOR ในระบบ</div>
              </div>
              <div className="p-2 rounded-xl bg-slate-50 border border-slate-200">
                <div className="text-base font-heading font-bold text-slate-800">45</div>
                <div className="text-[9px] text-slate-500">หน่วยงานที่เชื่อมต่อ</div>
              </div>
            </div>
            ...
            <div className="mt-3 flex space-x-1">
              <input
                ...
                className="flex-1 text-xs px-3 py-1.5 rounded-xl border border-slate-200 focus:outline-none focus:ring-1 focus:ring-indigo-600"
              />
              <button className="px-3 py-1.5 rounded-xl bg-indigo-600 text-white text-xs font-bold">
                ค้นหา
              </button>
            </div>
            ...
            <div className="mt-3 space-y-1.5 text-xs">
              <div className="flex items-center justify-between p-2 rounded-xl bg-slate-50">
                ...
                <span className="text-[10px] text-slate-400">25 พ.ค. 2569</span>
              </div>
              <div className="flex items-center justify-between p-2 rounded-xl bg-slate-50">
                <span className="text-slate-800 font-medium">ม.สงขลานครินทร์ (2569)</span>
                <span className="text-[10px] text-slate-400">24 พ.ค. 2569</span>
              </div>
              <div className="flex items-center justify-between p-2 rounded-xl bg-slate-50">
                <span className="text-slate-800 font-medium">กรมวิชาการเกษตร (2569)</span>
                <span className="text-[10px] text-slate-400">23 พ.ค. 2569</span>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white border border-slate-200/80 rounded-3xl p-5 shadow-xs flex flex-col justify-between space-y-4">
          <div>
            ...
            <div className="mt-3 space-y-1.5 text-xs">
              <div className="flex items-center justify-between p-2 rounded-xl bg-slate-50">
                ...
                <span className="text-[10px] text-slate-400">ตรวจสอบแล้ว 5 นาทีที่แล้ว</span>
              </div>
              <div className="flex items-center justify-between p-2 rounded-xl bg-slate-50">
              ...
              <div className="flex items-center justify-between p-2 rounded-xl bg-slate-50">
                <span className="text-slate-700">E-Marketplace</span>
                <span className="text-[10px] text-slate-400">3 นาทีที่แล้ว</span>
              </div>
            </div>

            <div className="mt-3 space-y-1">
              <div className="p-2 rounded-xl bg-amber-50 text-[11px] text-amber-900 border border-amber-200">
          ...
          <button className="w-full py-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-semibold flex items-center justify-center space-x-1">
      ...
      <div className="bg-white border border-slate-200/80 rounded-2xl p-3 shadow-xs flex flex-col md:flex-row justify-between items-center gap-3 text-xs">
