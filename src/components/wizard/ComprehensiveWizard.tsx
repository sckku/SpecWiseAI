      ...
      <div className="bg-white border border-slate-200/80 rounded-3xl p-6 sm:p-8 shadow-sm">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  />
                  <span className="absolute bottom-3 right-4 text-sm text-slate-400 font-mono">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    />
                    <span className="absolute right-3.5 top-3 text-sm text-slate-400">
                      เครื่อง
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-6">
                  ...
                  <div className="relative w-24 h-24 flex items-center justify-center shrink-0">
                    ...
                    <div className="absolute text-center">
                      ...
                      <div className="text-sm text-slate-400">ความพร้อม</div>
                    </div>
                  </div>
        ...
        {currentStep === 3 && (
          <div className="space-y-6">
            ...
            <div className="p-4 rounded-2xl bg-amber-50/70 border border-amber-200/80 flex items-center justify-between">
              ...
              <span className="px-2.5 py-1 rounded-full bg-amber-100 text-amber-800 text-sm font-semibold border border-amber-200">
            ...
            <div className="border-2 border-indigo-500 rounded-3xl p-5 bg-gradient-to-br from-indigo-50/40 via-purple-50/20 to-white shadow-md space-y-4">
              <div className="flex items-center justify-between">
                <span className="px-3 py-1 rounded-full bg-indigo-600 text-white text-sm font-heading font-bold">
                  อันดับ 1 (แนะนำ)
                </span>
              ...
              {/* Evidence Citation */}
              <div className="bg-white border border-slate-200 rounded-xl p-3.5 text-sm space-y-1">
            ...
            {/* Alternative Option */}
            <div className="border border-slate-200 rounded-2xl p-4 bg-slate-50/60 flex items-center justify-between text-sm">
              <div>
              ...
              <span className="px-2.5 py-1 rounded-full bg-slate-200 text-slate-700 text-sm font-semibold">
                ความสอดคล้อง 86%
              </span>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
              <div className="bg-slate-50 border border-slate-200/80 rounded-2xl p-4">
                ...
                <p className="text-sm text-slate-400 mt-0.5">สำนักงบประมาณ 2569</p>
              </div>
              ...
              <div className="bg-slate-50 border border-slate-200/80 rounded-2xl p-4">
                ...
                <p className="text-sm text-slate-400 mt-0.5">8 รายการ (ใน 90 วัน)</p>
              </div>
              ...
              <div className="bg-slate-50 border border-slate-200/80 rounded-2xl p-4">
                ...
                <p className="text-sm text-emerald-700 mt-0.5">บริษัท เอ จำกัด</p>
              </div>
              ...
              <div className="bg-slate-50 border border-slate-200/80 rounded-2xl p-4">
                ...
                <p className="text-sm text-slate-400 mt-0.5">จัดซื้อจริง มข. 2568</p>
              </div>
            </div>
            ...
            <div className="bg-white border border-slate-200/80 rounded-2xl p-5 space-y-4">
              ...
              <h4 className="font-heading font-bold text-sm text-slate-700 uppercase tracking-wider">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-center justify-between p-2.5 rounded-xl bg-emerald-50/60 border border-emerald-100">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm px-2 py-0.5 rounded bg-emerald-200 text-emerald-800 font-bold">
                      ⭐ ต่ำสุด
                    </span>
                  </div>
            ...
            <div className="p-5 rounded-2xl bg-amber-50/80 border border-amber-200 text-amber-950 space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm mt-1 text-amber-900 leading-relaxed">
              ...
              <div className="pt-3 border-t border-amber-200/60 grid grid-cols-2 sm:grid-cols-4 gap-2 text-sm">
                <div>
                  <span className="text-amber-800 text-sm">วงเงินที่เสนอ:</span>
                  <div className="font-bold text-amber-950">50,000 บาท/เครื่อง</div>
                </div>
                <div>
                  <span className="text-amber-800 text-sm">ราคามาตรฐาน:</span>
                  <div className="font-semibold text-amber-950">26,000 บาท</div>
                </div>
                <div>
                  <span className="text-amber-800 text-sm">ราคากลาง Median:</span>
                  <div className="font-semibold text-amber-950">28,900 บาท</div>
                </div>
                <div>
                  <span className="text-amber-800 text-sm">ใบเสนอราคาต่ำสุด:</span>
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-5 space-y-3">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-center justify-between p-3 rounded-xl bg-amber-50/50 border border-amber-100">
                  ...
                  <span className="text-sm font-bold text-amber-800">จำเป็นต้องแนบ</span>
                </div>
                ...
                <div className="flex items-center justify-between p-3 rounded-xl bg-amber-50/50 border border-amber-100">
                  ...
                  <span className="text-sm font-bold text-amber-800">จำเป็นต้องระบุ</span>
                </div>
                ...
                <div className="flex items-center justify-between p-3 rounded-xl bg-emerald-50/50 border border-emerald-100">
                  ...
                  <span className="text-sm font-bold text-emerald-800">AI สร้างให้ในขั้นตอนถัดไป</span>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="flex justify-between items-center">
              ...
              <div className="flex space-x-2">
                <button className="px-3 py-1.5 rounded-xl border border-slate-200 text-sm font-medium text-slate-700 hover:bg-slate-50">
                  พรีวิวเอกสาร
                </button>
                <button className="px-3 py-1.5 rounded-xl border border-slate-200 text-sm font-medium text-slate-700 hover:bg-slate-50">
                  Word
                </button>
                <button className="px-3 py-1.5 rounded-xl bg-indigo-50 text-indigo-700 border border-indigo-200 text-sm font-bold">
                  PDF
                </button>
              </div>
            </div>
            ...
            <div className="border border-slate-200 rounded-2xl divide-y divide-slate-100 text-sm">
              ...
              <div className="p-4 space-y-2">
                <div className="font-semibold text-indigo-900 flex items-center justify-between">
                  ...
                  <span className="text-sm text-indigo-600">อ้างอิง: เกณฑ์กระทรวงดิจิทัลฯ</span>
                </div>
            ...
            <div className="bg-slate-50 border border-slate-200/80 rounded-2xl p-4 space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-sm">
                <div className="p-3 rounded-xl bg-white border border-slate-200">
                  ...
                  <div className="text-emerald-600 font-bold text-sm mt-1">ความสอดคล้อง 92%</div>
                </div>
                <div className="p-3 rounded-xl bg-white border border-slate-200">
                  <span className="font-semibold text-slate-800">มหาวิทยาลัย B (2568)</span>
                  <div className="text-emerald-600 font-bold text-sm mt-1">ความสอดคล้อง 88%</div>
                </div>
                <div className="p-3 rounded-xl bg-white border border-slate-200">
                  <span className="font-semibold text-slate-800">หน่วยงาน C (2568)</span>
                  <div className="text-emerald-600 font-bold text-sm mt-1">ความสอดคล้อง 85%</div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                <div className="p-3 rounded-xl bg-white border border-slate-200 flex items-center justify-between">
                  ...
                  <span className="text-sm font-mono text-slate-400">PDF</span>
                </div>
        ...
        {currentStep === 9 && (
          <div className="space-y-6">
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 text-center space-y-3">
                <div className="relative w-36 h-36 mx-auto flex items-center justify-center">
                  ...
                  <div className="absolute text-center">
                    ...
                    <div className="text-sm text-slate-500">ความพร้อม</div>
                  </div>
                </div>
            ...
            {/* Warning Note */}
            <div className="p-3.5 rounded-2xl bg-amber-50 border border-amber-200 text-sm text-amber-900">
            ...
            <div className="pt-4 border-t border-slate-100 flex justify-between">
              ...
              <div className="flex space-x-2">
                <button
                  ...
                  className="px-4 py-2.5 rounded-xl border border-slate-300 hover:bg-slate-50 text-sm font-semibold text-slate-700"
                >
                  บันทึกแบบร่าง
                </button>
                <button
                  onClick={handleSubmit}
                  disabled={isSubmitted}
                  className="px-6 py-2.5 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-heading font-bold text-sm shadow-md shadow-indigo-500/25 flex items-center space-x-1.5"
                >
                  {isSubmitted ? (
                    <>
                      <Loader2 className="w-4 h-4 animate-spin" />
