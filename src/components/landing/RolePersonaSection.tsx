...
export function RolePersonaSection() {
  ...
  const roles = [
    {
      title: "ผู้ขอตั้งงบประมาณ (Requester)",
      sub: "อาจารย์, นักวิจัย, หัวหน้าโครงการ",
      icon: GraduationCap,
      color: "from-indigo-500 to-blue-600",
      accent: "indigo",
      points: [
        "พิมพ์ความต้องการภาษาธรรมชาติ AI แปลงเป็นสเปกทางการทันที",
        "ร่างเอกสารคำขอ 8 หมวดหมู่ตามแบบฟอร์ม มข. ครบถ้วน ไม่ตกหล่น",
        "มี AI แจ้งเตือนข้อผิดพลาดก่อนส่ง ลดโอกาสการถูกตีกลับเป็น 0%",
      ],
      quote: "เดิมต้องใช้เวลาเกือบสัปดาห์ในการค้นหาราคากลางและเขียนแบบฟอร์ม ตอนนี้เสร็จใน 15 นาที พร้อมส่งตรวจได้ทันที",
    },
    {
      title: "ผู้ตรวจระดับภาควิชา (Dept Verifier)",
      sub: "เจ้าหน้าที่งานแผน, งานพัสดุ และการเงินภาควิชา",
      icon: Shield,
      color: "from-blue-500 to-cyan-600",
      accent: "blue",
      points: [
        "ระบบ Cross-Check ราคากลาง 4 ฐาน พร้อม Citation หน้า/ข้อ ชัดเจน",
        "ตรวจจับการล็อคสเปกการค้าและแจ้งเตือนอัตโนมัติ",
        "มี AI Summary สรุปจุดสำคัญให้ตรวจทานได้ในไม่กี่นาที",
      ],
      quote: "ช่วยตรวจเทียบราคากลางและสัญญาจัดซื้อย้อนหลังให้อัตโนมัติ ทำให้งานตรวจสอบรวดเร็วและแม่นยำขึ้นมาก",
    },
    {
      title: "ผู้อนุมัติระดับคณะ (Faculty Approver)",
      sub: "คณบดี, รองคณบดีฝ่ายแผน, กรรมการกลั่นกรองงบ",
      icon: Building2,
      color: "from-amber-500 to-orange-600",
      accent: "amber",
      points: [
        "Executive Dashboard วิเคราะห์ภาพรวมงบลงทุนและความคุ้มค่า",
        "ดูสถานะคำขอและคะแนนความสมเหตุสมผล (Reasonableness Score)",
        "อนุมัติหรือส่งกลับพร้อมข้อเสนอแนะผ่านระบบได้อย่างรวดเร็ว",
      ],
      quote: "เห็นภาพรวมการจัดสรรงบประมาณของทุกภาควิชา และมั่นใจได้ว่าทุกรายการถูกต้องตามระเบียบราชการ",
    },
    {
      title: "ผู้ดูแลระบบพัสดุ มข. (Procurement Admin)",
      sub: "กองคลังและพัสดุ มหาวิทยาลัยขอนแก่น",
      icon: Sparkles,
      color: "from-purple-500 to-pink-600",
      accent: "purple",
      points: [
        "จัดการและอัปเดตบัญชีราคามาตรฐานครุภัณฑ์ สำนักงบฯ และ มข.",
        "ระบบตรวจสอบ Audit Trail ย้อนหลัง ป้องกันปัญหาการตรวจสอบจาก สตง.",
        "รายงานสถิติการประหยัดเวลา (NVA Time Saved) และประสิทธิภาพงบประมาณ",
      ],
      quote: "มาตรฐานข้อมูลเดียวกันทั้งมหาวิทยาลัย ปลอดภัยจากการล็อคสเปก และเชื่อมโยงฐานข้อมูลภาครัฐอย่างสมบูรณ์",
    },
  ];
