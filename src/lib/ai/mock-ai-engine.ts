...
export function simulateStep1(promptText: string): Step1IntentResult {
  ...
  let targetDepartment = "สาขาวิชาเคมี คณะวิทยาศาสตร์";
...
export function simulateStep5(
  ...
  return {
    ...
    section2Necessity: {
      ...
      targetCurriculum: "หลักสูตรวิทยาศาสตรบัณฑิต และหลักสูตรวิทยาศาสตรมหาบัณฑิต สาขาวิชาเคมี",
      userCount: 150,
      ...
      urgency: "มีความจำเป็นเร่งด่วนเพื่อรองรับการเปิดภาคการศึกษาที่ 1/2570 และงานวิจัยร่วมกับภาคอุตสาหกรรม",
    },
    ...
    section8AdditionalNotes: "รายการคำของบประมาณนี้ได้ผ่านความเห็นชอบจากคณะกรรมการประจำคณะและสอดคล้องกับแผนยุทธศาสตร์ มข. พ.ศ. 2570-2574",
  };
}
